...
function removeCellsWithUniquenessCheck(fullGrid, maxRemove = 35) {
...
let puzzleGrid = removeCellsWithUniquenessCheck(solutionGrid, 35);
...
function returnPuzzle() {
  ...
  puzzleGrid = removeCellsWithUniquenessCheck(solutionGrid, 35);
