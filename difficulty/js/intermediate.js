...
function removeCellsWithUniquenessCheck(fullGrid, maxRemove = 40) {
...
let puzzleGrid = removeCellsWithUniquenessCheck(solutionGrid, 40);
...
function returnPuzzle() {
  ...
  puzzleGrid = removeCellsWithUniquenessCheck(solutionGrid, 40);
